<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                <a href="/home"><i class="fa fa-th-large"></i> <span class="nav-label">Home</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li class="{{ Request::is('home') ? 'active' :'' }}"><a href="{{URL::to('/home')}}">Home</a></li>
                    <li class="{{   Request::is('doctors') ? 'active' :'' }}"><a href="{{URL::to('/doctors')}}">Doctors</a></li>
                    <li class="{{ Request::is('doctorschedules') ? 'active' :'' }}"><a href="{{URL::to('/doctorschedules')}}">Doctor Schedules</a></li>
