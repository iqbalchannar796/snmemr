                      ...
                      <div class="ibox float-e-margins">
                          ...
                          <div>
                              <div class="ibox-content no-padding border-left-right" style="text-align: center">
                                  {{Form::image($doctor->profilepicture, $doctor->firstname.' '.$doctor->lastname)}}
                              </div>
                              ...
                              <div>
                                  <div class="feed-activity-list">
                                      ...
                                      <div class="feed-element">
                                          ...
                                          <div class="media-body ">
                                              <strong>{{date('M j, Y', strtotime($doctor->created_at))}}</strong>
                                          </div>
                                      </div>
                                      ...
                                      <div class="feed-element">
                                          ...
                                          <div class="media-body ">
                                              <strong>{{date('M j, Y', strtotime($doctor->updated_at))}}</strong>
                                          </div>

                                      </div>
                                      {!! Html::linkRoute('doctors.index','<< See All Doctors', [], ['class'=>'btn btn-primary btn-block'])!!}
